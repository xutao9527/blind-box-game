...
public class GenScheduler {
    ...
    public void generateCode(){
        String extPackagePath = Paths.get(System.getProperty("user.dir")).getParent()
                .resolve("game-scheduler")
                .resolve("src")
                .resolve("main")
                .resolve("java")
                .toString();
        CodeGenNormal codeGenNormal = new CodeGenNormal();
        codeGenNormal.generateService(bizTables, "com.bbg.schedule", ".biz", extPackagePath);
        codeGenNormal.generateService(csgoTables, "com.bbg.schedule", ".csgo", extPackagePath);
        // codeGenNormal.generateController(bizTables, "com.bbg.schedule", ".biz", extPackagePath, "/templates/enjoy/CustomAppController.tpl");
        // codeGenNormal.generateController(csgoTables, "com.bbg.schedule", ".csgo", extPackagePath, "/templates/enjoy/CustomAppController.tpl");
