...
public class CustomVueEditGenerator implements IGenerator {

    private String templatePath = "/templates/enjoy/CustomVueEdit.tpl";

    @Override
    public String getTemplatePath() {
        return "/templates/enjoy/CustomVueEdit.tpl";
    }
    ...
    public void generate(Table table, GlobalConfig globalConfig) {
        Boolean overwrite = (Boolean) globalConfig.getCustomConfig("VueEditOverwriteEnable");
        ...
        if (overwrite != null) {
            if (!vueFile.exists() || overwrite) {
                ...
                System.out.println("EditVue ---> " + vueFile);
            }
        }
    }
}
