...
import com.bbg.box.service.csgo.CsgoBattleRoomBoxService;
...
public class CsgoBattleRoomBoxController extends BaseController<CsgoBattleRoomBox, CsgoBattleRoomBoxService> {
    @Autowired
