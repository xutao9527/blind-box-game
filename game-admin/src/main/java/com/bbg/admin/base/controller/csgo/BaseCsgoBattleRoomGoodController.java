...
import com.bbg.admin.service.csgo.CsgoBattleRoomGoodService;
...
public class BaseCsgoBattleRoomGoodController extends BaseController<CsgoBattleRoomGood, CsgoBattleRoomGoodService> {
    @Autowired
